...
import { fetch, Headers } from "undici"; //included in node.js 18
...
function request(href, option = {}){
  ...
  const options = {
    ...
    timeout: isIntegerWithinRange(option.timeout, 0, 300) ? option.timeout : 300,/*(in sec)*/ //fetch has an non configurable inbuild timeout of 300sec --> can be cfg via dispatcher ? (undici)
...
function parseHeaders(headers) {
  return Object.assign(Object.create(null), Object.fromEntries(headers.entries()));
}
